...
const quickNavItems: WorkbenchQuickNavItem[] = [
  ...
  },
  {
    ...
    title: '商户列表',
    url: '/merchant/mch/index',
  },
  {
    color: '#e18525',
    icon: 'ant-design:appstore-outlined',
    title: '通道列表',
    url: '/payconfig/apps/index',
  },
  {
    color: '#bf0c2c',
    icon: 'ant-design:wallet-outlined',
    title: '商户预付',
    url: '/merchant/prepaid-history/index',
  },
  {
    color: '#4daf1bc9',
    icon: 'ant-design:account-book-outlined',
    title: '通道预付',
    url: '/payconfig/passage-prepaid-history/index',
  },
  {
    color: '#00d8ff',
    icon: 'ant-design:bar-chart-outlined',
    title: '平台日终',
    url: '/payconfig/plat-stat/index',
  },
];
