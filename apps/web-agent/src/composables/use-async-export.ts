...
export function useAsyncExportTask(options: UseAsyncExportTaskOptions) {
  ...
  function isActive(task: AgentExportTask | null | undefined) {
    return (
      task != null &&
  ...
  function isTerminal(task: AgentExportTask | null | undefined) {
    return (
      !!task &&
  ...
  function applyRunningTask(task: AgentExportTask | null | undefined) {
  ...
  function mapCompleted(list: AgentExportTask[]) {
  ...
  async function deleteCompletedItem(row: AgentExportTask) {
    if (!row?.objectKey) {
